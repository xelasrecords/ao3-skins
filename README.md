...
1. To revert to the default font size, delete the code below:
   ...
   ```
   You can also tweak the percentage to your liking.
2. To retain the greyed-out state for visited links, go to the code below and replace the hex code with the alternative colour written in the file:
   ```
   a.tag:visited, .blurb h4 a:visited {
    color: #xxxxxx !important;
   }
   ```
4. Try creating the skin on desktop if errors occur after applying it on mobile.
